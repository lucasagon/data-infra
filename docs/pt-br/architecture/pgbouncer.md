...
|---|---|---|---|
| `pgbouncer.ini` | `infra/pgbouncer/pgbouncer.ini` | `/etc/pgbouncer/pgbouncer.ini` | Configuração principal |
| `userlist.txt` | `infra/pgbouncer/userlist.txt` | `/etc/pgbouncer/userlist.txt` | Credenciais do auth_user |
